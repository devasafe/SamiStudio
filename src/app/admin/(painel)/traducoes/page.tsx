...
/** Editor de textos do site, campo a campo, por idioma (Docs/12). */
export default function AdminTranslationsPage() {
  ...
  const fields = useMemo(() => flatten(baseDictionaries[locale]), [locale]);
  ...
  async function handleSave() {
    ...
    try {
      await api("/translations", {
        method: "PATCH",
        json: { locale, content: unflatten(overrides) },
      });
